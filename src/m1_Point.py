...
class Point(object):
    ...
    def move_to(self, new_x, new_y):
        self.dis += self.get_distance_from(Point(new_x, new_y))
        self.x = new_x
        self.y = new_y
        self.moves += 1

    def move_by(self, dx, dy):
        self.dis += self.get_distance_from(Point(self.x + dx, self.y + dy))
        self.x = self.x + dx
        self.y = self.y + dy
        self.moves += 1
    ...
    def get_distance_from(self, end):
        ...
        r = ma.sqrt(((x2-x1)**2) + ((y2-y1)**2))
        return r

    def get_distance_from_start(self):
        r = ma.sqrt(((self.x - self.startX)**2) + ((self.y - self.startY)**2))
        return r
...
def test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # TO DO: 5.  Follow the same instructions as in TO DO 3 above,
...
def test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 6.  Follow the same instructions as in TO DO 3 above,
...
def test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 7.  Follow the same instructions as in TO DO 3 above,
...
def test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 9.  Follow the same instructions as in TO DO 3 above,
...
def test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 10.  Follow the same instructions as in TO DO 3 above,
...
def test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 11.  Follow the same instructions as in TO DO 3 above,
...
def test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # TO DO: 12.  Follow the same instructions as in TO DO 3 above,
